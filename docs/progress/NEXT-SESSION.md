...
**Visualizer templates pedagogy redesign** — make the 8 fundamentals templates genuinely instructive, per the approved 3-stage spec: `docs/superpowers/specs/2026-07-05-visualizer-pedagogy-redesign.md`. Stage 1 (bug fixes) DONE; Stage 2 (shared primitives) DONE; Stage 3 pilot (event-loop) DONE — **next: roll the replay model out to the remaining 7 templates**.
